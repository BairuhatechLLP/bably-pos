export const UpdateEmailTemplate = (data: any) => {
  const Token = data?.verifyId?.tokenid;
  const userId = data?.userId;
  const email = `https://www.taxgoglobal.com/emailUpdated/${userId}/${Token}`;
  const firstName = data?.verifyId?._previousDataValues?.firstname;
  ...
  return `
      ...
      <br/>
      <p><b class="subjectText">Subject: Important: Updating The Email</b></p>
