export const ResetPasswordTemplate = (data: any) => {
  const email = `https://www.taxgoglobal.com/reset-password/${data.token}`;
  //const email = `http://localhost:3000/reset-password/${data.token}`

  const firstName = data.user.dataValues.firstname;
  return `
    ...
    <body style='margin: 0; padding: 0'>
      ...
      <br />
    <br/>
    <p><b class="subjectText">Subject: Important: Reset the Password</b></p>
