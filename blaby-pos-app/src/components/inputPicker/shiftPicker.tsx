  ...
  const showLabel = (data: any) => {
    try {
      if (props?.options?.length) {
        let value = `${props?.value?.name} - (${props?.value?.fromtime.toString()} to ${props?.value.totime.toString()})`;
        return value;
      } else {
  ...
  return (
    <View>
      ...
      <TouchableOpacity
        ...
        <View style={{flex: 1}}>
          <Text style={props.value ? styles.text2 : styles.text1}>
                      ...
                      <TouchableOpacity
                        ...
                        <View style={{flex: 1}}>
                          <Text style={styles.ItemText} numberOfLines={2}>
                            {item?.name} - ({item?.fromtime.toString()} to{' '}
